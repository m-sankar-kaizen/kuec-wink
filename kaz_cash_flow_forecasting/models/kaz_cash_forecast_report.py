...
class KazCashForecastReport(models.Model):
    _name = 'kaz.cash.forecast.report'
    _description = "kaz Cash Forecast Report"
    _auto = False
    ...
    def init(self):
        ...
        self._cr.execute("""
            CREATE or REPLACE view {} as (
                ...
                FROM kaz_cash_forecast cf
                JOIN kaz_cash_forecast_type ft on ft.id = cf.forecast_type_id
                JOIN kaz_cash_forecast_categories fg on fg.id = ft.cash_forecast_category_id
