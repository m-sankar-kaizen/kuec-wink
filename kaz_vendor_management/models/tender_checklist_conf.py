...
class TenderChecklistConf(models.Model):
    _name = 'tender.checklist.conf'
    _description = 'Tender Checklist Configuration'
    ...
    partner_category_ids = fields.Many2many('partner.category', string='Partner Category')
