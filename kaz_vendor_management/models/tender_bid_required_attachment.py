...
class TenderBidRequiredAttachment(models.Model):
    _name = 'tender.bid.required.attachment'
    _description = 'Tender Bid Required Attachment'
            ...
            if company_id not in sequence_cache:
                ...
                last_record = self.sudo().search(
                    [('company_id', '=', company_id),
                     ('tender_bid_id', '=', vals.get('tender_bid_id'))],
                    order='sequence desc',
                    limit=1
                )
