...
class HrCustody(models.Model):
    ...
    def action_set_to_return(self):
        ...
        custody record to the 'return_approval' state"""
        self.state = 'return_approval'
    ...
    def validate_return_date(self):
        ...
        if self.return_date and self.date_request and (self.return_date < self.date_request):
    ...
    custody_type = fields.Selection([
        ('permanent_custody', 'Permanent Custody'),
