...
export class TenderRfqDashBoard extends Component {
    static template = "kaz_kuec_tender_dashboard.TenderRfqDashboard";
    static props = {};
    setup() {
        ...
        onWillStart(async () => {
            this.tenderRfqData = await this.orm.call("tender.rfq", "retrieve_dashboard");
        });
    }
