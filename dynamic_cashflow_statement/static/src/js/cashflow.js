...
class CashFlow extends Component {
    ...
    toggleAccount(accountCode) {
        if (this.state.expandedAccounts.has(accountCode)) {
            this.state.expandedAccounts.delete(accountCode);
        } else {
            this.state.expandedAccounts.add(accountCode);
        }
    }
