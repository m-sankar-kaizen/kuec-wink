...
from odoo.addons.kaz_advanced_web_domain_widget.models.domain_prepare import prepare_domain_v2
...
class BaseModel(models.AbstractModel):
    ...
    def _get_view(self, view_id=None, view_type='form', **options):
        ...
        readonly_access_id = access_management_obj.sudo().search(
            [('company_ids', 'in', self.env.company.id), ('active', '=', True), ('user_ids', 'in', self.env.user.ids),
             ('readonly', '=', True)])
